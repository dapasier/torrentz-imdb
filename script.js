					...
					r.onload = function () {
						...
						if(result.Response !== 'False') {
							...
							if(!isNaN(rating)) {
								...
								span.innerHTML = '<a title="' + result.Runtime + '" href="http://www.imdb.com/title/' + result.imdbID + '" target="_blank"><div style="background-color:hsl(' + rating * 12 + ', 90%, 45%);" class="imdb-rating">' + rating + '</div></a>';
